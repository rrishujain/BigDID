 ...
 * @author tanmay
 */
public class Feedback_Order_Weeks_Controller {

    Feedback_Order_Weeks FOW;
    Sentiment_Week_Revised_one swro;

    public Feedback_Order_Weeks_Controller() throws UnknownHostException {
        this.FOW = new Feedback_Order_Weeks();
        this.swro = new Sentiment_Week_Revised_one();
    }
    ...
    public HashMap getFeedback() {
        ...
        data_feedback = FOW.getFeedback();
        data_sentiment = swro.getSentiment();
