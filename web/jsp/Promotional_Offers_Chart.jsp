...
<html>
    <head>
        ...
        offers_poc=(ArrayList<Long>)getServletContext().getAttribute("Offers");
        count_poc=(HashMap)getServletContext().getAttribute("Positive_Count");
        date_poc=(ArrayList<String>)getServletContext().getAttribute("Date");
