 ...
 * @author tanmay
 */
public class Customer_Sentiment_Month_Revised {
    ...
    public Customer_Sentiment_Month_Revised() throws UnknownHostException {
        coll = db.getCollection("sentiment_order_months");
    }
    ...
    public void getSentiment() {
        ...
        while (obj.hasNext()) {
            ...
            if (i % 2 == 0) {
                ...
                String s = (String) dbObj.get("month");
                month.add(s);
