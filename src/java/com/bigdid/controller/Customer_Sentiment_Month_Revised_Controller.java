...
import com.bigdid.scrap.model.Customer_Sentiment_Month_Revised;
 ...
 * @author tanmay
 */
public class Customer_Sentiment_Month_Revised_Controller {

    Customer_Sentiment_Month_Revised CSW;
    ...
    public Customer_Sentiment_Month_Revised_Controller() throws UnknownHostException {
        this.CSW = new Customer_Sentiment_Month_Revised();
        CSW.getSentiment();
    }
