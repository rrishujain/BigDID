 ...
 * @author tanmay
 */
public class Feedback_Order_Month_Servlet extends HttpServlet {
     ServletContext sc;
     Feedback_Order_Months FOD;
     Sentiment_Month_Revised_one sdro;
    ...
    public void init(ServletConfig scfig) throws ServletException {
       ...
       Iterator i = set.iterator();
        ...
        sc=scfig.getServletContext();
         sc.setAttribute("Feedback_Order_Months",finalDataSet );
    }
}
